...
var _ MappedNullable = &PaginatedSavedFilterList{}
...
type _PaginatedSavedFilterList PaginatedSavedFilterList
...
func (o *PaginatedSavedFilterList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedSavedFilterList(varPaginatedSavedFilterList)
...
type NullablePaginatedSavedFilterList struct {
	value *PaginatedSavedFilterList
	isSet bool
}

func (v NullablePaginatedSavedFilterList) Get() *PaginatedSavedFilterList {
	return v.value
}

func (v *NullablePaginatedSavedFilterList) Set(val *PaginatedSavedFilterList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedSavedFilterList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedSavedFilterList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedSavedFilterList(val *PaginatedSavedFilterList) *NullablePaginatedSavedFilterList {
	return &NullablePaginatedSavedFilterList{value: val, isSet: true}
}

func (v NullablePaginatedSavedFilterList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedSavedFilterList) UnmarshalJSON(src []byte) error {
	v.isSet = true
