...
var _ MappedNullable = &PaginatedDeviceTypeList{}
...
type _PaginatedDeviceTypeList PaginatedDeviceTypeList
...
func (o *PaginatedDeviceTypeList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedDeviceTypeList(varPaginatedDeviceTypeList)
...
type NullablePaginatedDeviceTypeList struct {
	value *PaginatedDeviceTypeList
	isSet bool
}

func (v NullablePaginatedDeviceTypeList) Get() *PaginatedDeviceTypeList {
	return v.value
}

func (v *NullablePaginatedDeviceTypeList) Set(val *PaginatedDeviceTypeList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedDeviceTypeList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedDeviceTypeList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedDeviceTypeList(val *PaginatedDeviceTypeList) *NullablePaginatedDeviceTypeList {
	return &NullablePaginatedDeviceTypeList{value: val, isSet: true}
}

func (v NullablePaginatedDeviceTypeList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedDeviceTypeList) UnmarshalJSON(src []byte) error {
	v.isSet = true
