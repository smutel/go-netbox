...
var _ MappedNullable = &PaginatedModuleBayList{}
...
type _PaginatedModuleBayList PaginatedModuleBayList
...
func (o *PaginatedModuleBayList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedModuleBayList(varPaginatedModuleBayList)
...
type NullablePaginatedModuleBayList struct {
	value *PaginatedModuleBayList
	isSet bool
}

func (v NullablePaginatedModuleBayList) Get() *PaginatedModuleBayList {
	return v.value
}

func (v *NullablePaginatedModuleBayList) Set(val *PaginatedModuleBayList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedModuleBayList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedModuleBayList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedModuleBayList(val *PaginatedModuleBayList) *NullablePaginatedModuleBayList {
	return &NullablePaginatedModuleBayList{value: val, isSet: true}
}

func (v NullablePaginatedModuleBayList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedModuleBayList) UnmarshalJSON(src []byte) error {
	v.isSet = true
