...
var _ MappedNullable = &PaginatedVLANList{}
...
type _PaginatedVLANList PaginatedVLANList
...
func (o *PaginatedVLANList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedVLANList(varPaginatedVLANList)
...
type NullablePaginatedVLANList struct {
	value *PaginatedVLANList
	isSet bool
}

func (v NullablePaginatedVLANList) Get() *PaginatedVLANList {
	return v.value
}

func (v *NullablePaginatedVLANList) Set(val *PaginatedVLANList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedVLANList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedVLANList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedVLANList(val *PaginatedVLANList) *NullablePaginatedVLANList {
	return &NullablePaginatedVLANList{value: val, isSet: true}
}

func (v NullablePaginatedVLANList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedVLANList) UnmarshalJSON(src []byte) error {
	v.isSet = true
