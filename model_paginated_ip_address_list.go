...
var _ MappedNullable = &PaginatedIPAddressList{}
...
type _PaginatedIPAddressList PaginatedIPAddressList
...
func (o *PaginatedIPAddressList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedIPAddressList(varPaginatedIPAddressList)
...
type NullablePaginatedIPAddressList struct {
	value *PaginatedIPAddressList
	isSet bool
}

func (v NullablePaginatedIPAddressList) Get() *PaginatedIPAddressList {
	return v.value
}

func (v *NullablePaginatedIPAddressList) Set(val *PaginatedIPAddressList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedIPAddressList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedIPAddressList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedIPAddressList(val *PaginatedIPAddressList) *NullablePaginatedIPAddressList {
	return &NullablePaginatedIPAddressList{value: val, isSet: true}
}

func (v NullablePaginatedIPAddressList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedIPAddressList) UnmarshalJSON(src []byte) error {
	v.isSet = true
