...
var _ MappedNullable = &PaginatedVirtualDiskList{}
...
type _PaginatedVirtualDiskList PaginatedVirtualDiskList
...
func (o *PaginatedVirtualDiskList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedVirtualDiskList(varPaginatedVirtualDiskList)
...
type NullablePaginatedVirtualDiskList struct {
	value *PaginatedVirtualDiskList
	isSet bool
}

func (v NullablePaginatedVirtualDiskList) Get() *PaginatedVirtualDiskList {
	return v.value
}

func (v *NullablePaginatedVirtualDiskList) Set(val *PaginatedVirtualDiskList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedVirtualDiskList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedVirtualDiskList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedVirtualDiskList(val *PaginatedVirtualDiskList) *NullablePaginatedVirtualDiskList {
	return &NullablePaginatedVirtualDiskList{value: val, isSet: true}
}

func (v NullablePaginatedVirtualDiskList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedVirtualDiskList) UnmarshalJSON(src []byte) error {
	v.isSet = true
