...
var _ MappedNullable = &PaginatedDeviceBayTemplateList{}
...
type _PaginatedDeviceBayTemplateList PaginatedDeviceBayTemplateList
...
func (o *PaginatedDeviceBayTemplateList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedDeviceBayTemplateList(varPaginatedDeviceBayTemplateList)
...
type NullablePaginatedDeviceBayTemplateList struct {
	value *PaginatedDeviceBayTemplateList
	isSet bool
}

func (v NullablePaginatedDeviceBayTemplateList) Get() *PaginatedDeviceBayTemplateList {
	return v.value
}

func (v *NullablePaginatedDeviceBayTemplateList) Set(val *PaginatedDeviceBayTemplateList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedDeviceBayTemplateList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedDeviceBayTemplateList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedDeviceBayTemplateList(val *PaginatedDeviceBayTemplateList) *NullablePaginatedDeviceBayTemplateList {
	return &NullablePaginatedDeviceBayTemplateList{value: val, isSet: true}
}

func (v NullablePaginatedDeviceBayTemplateList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedDeviceBayTemplateList) UnmarshalJSON(src []byte) error {
	v.isSet = true
