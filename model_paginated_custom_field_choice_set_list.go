...
var _ MappedNullable = &PaginatedCustomFieldChoiceSetList{}
...
type NullablePaginatedCustomFieldChoiceSetList struct {
	value *PaginatedCustomFieldChoiceSetList
	isSet bool
}

func (v NullablePaginatedCustomFieldChoiceSetList) Get() *PaginatedCustomFieldChoiceSetList {
	return v.value
}

func (v *NullablePaginatedCustomFieldChoiceSetList) Set(val *PaginatedCustomFieldChoiceSetList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedCustomFieldChoiceSetList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedCustomFieldChoiceSetList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedCustomFieldChoiceSetList(val *PaginatedCustomFieldChoiceSetList) *NullablePaginatedCustomFieldChoiceSetList {
	return &NullablePaginatedCustomFieldChoiceSetList{value: val, isSet: true}
}

func (v NullablePaginatedCustomFieldChoiceSetList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedCustomFieldChoiceSetList) UnmarshalJSON(src []byte) error {
	v.isSet = true
