...
// checks if the JournalEntryRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JournalEntryRequest{}
...
func (o JournalEntryRequest) ToMap() (map[string]interface{}, error) {
...
func (o *JournalEntryRequest) UnmarshalJSON(data []byte) (err error) {
