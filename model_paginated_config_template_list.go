...
var _ MappedNullable = &PaginatedConfigTemplateList{}
...
type _PaginatedConfigTemplateList PaginatedConfigTemplateList
...
func (o *PaginatedConfigTemplateList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedConfigTemplateList(varPaginatedConfigTemplateList)
...
type NullablePaginatedConfigTemplateList struct {
	value *PaginatedConfigTemplateList
	isSet bool
}

func (v NullablePaginatedConfigTemplateList) Get() *PaginatedConfigTemplateList {
	return v.value
}

func (v *NullablePaginatedConfigTemplateList) Set(val *PaginatedConfigTemplateList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedConfigTemplateList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedConfigTemplateList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedConfigTemplateList(val *PaginatedConfigTemplateList) *NullablePaginatedConfigTemplateList {
	return &NullablePaginatedConfigTemplateList{value: val, isSet: true}
}

func (v NullablePaginatedConfigTemplateList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedConfigTemplateList) UnmarshalJSON(src []byte) error {
	v.isSet = true
