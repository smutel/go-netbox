...
var _ MappedNullable = &PaginatedBookmarkList{}
...
type _PaginatedBookmarkList PaginatedBookmarkList
...
func (o *PaginatedBookmarkList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedBookmarkList(varPaginatedBookmarkList)
...
type NullablePaginatedBookmarkList struct {
	value *PaginatedBookmarkList
	isSet bool
}

func (v NullablePaginatedBookmarkList) Get() *PaginatedBookmarkList {
	return v.value
}

func (v *NullablePaginatedBookmarkList) Set(val *PaginatedBookmarkList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedBookmarkList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedBookmarkList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedBookmarkList(val *PaginatedBookmarkList) *NullablePaginatedBookmarkList {
	return &NullablePaginatedBookmarkList{value: val, isSet: true}
}

func (v NullablePaginatedBookmarkList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedBookmarkList) UnmarshalJSON(src []byte) error {
	v.isSet = true
