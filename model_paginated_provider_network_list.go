...
var _ MappedNullable = &PaginatedProviderNetworkList{}
...
type _PaginatedProviderNetworkList PaginatedProviderNetworkList
...
func (o *PaginatedProviderNetworkList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedProviderNetworkList(varPaginatedProviderNetworkList)
...
type NullablePaginatedProviderNetworkList struct {
	value *PaginatedProviderNetworkList
	isSet bool
}

func (v NullablePaginatedProviderNetworkList) Get() *PaginatedProviderNetworkList {
	return v.value
}

func (v *NullablePaginatedProviderNetworkList) Set(val *PaginatedProviderNetworkList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedProviderNetworkList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedProviderNetworkList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedProviderNetworkList(val *PaginatedProviderNetworkList) *NullablePaginatedProviderNetworkList {
	return &NullablePaginatedProviderNetworkList{value: val, isSet: true}
}

func (v NullablePaginatedProviderNetworkList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedProviderNetworkList) UnmarshalJSON(src []byte) error {
	v.isSet = true
