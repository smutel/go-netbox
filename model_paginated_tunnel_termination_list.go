...
var _ MappedNullable = &PaginatedTunnelTerminationList{}
...
type _PaginatedTunnelTerminationList PaginatedTunnelTerminationList
...
func (o *PaginatedTunnelTerminationList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedTunnelTerminationList(varPaginatedTunnelTerminationList)
...
type NullablePaginatedTunnelTerminationList struct {
	value *PaginatedTunnelTerminationList
	isSet bool
}

func (v NullablePaginatedTunnelTerminationList) Get() *PaginatedTunnelTerminationList {
	return v.value
}

func (v *NullablePaginatedTunnelTerminationList) Set(val *PaginatedTunnelTerminationList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedTunnelTerminationList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedTunnelTerminationList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedTunnelTerminationList(val *PaginatedTunnelTerminationList) *NullablePaginatedTunnelTerminationList {
	return &NullablePaginatedTunnelTerminationList{value: val, isSet: true}
}

func (v NullablePaginatedTunnelTerminationList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedTunnelTerminationList) UnmarshalJSON(src []byte) error {
	v.isSet = true
