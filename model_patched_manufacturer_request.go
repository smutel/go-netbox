...
// checks if the PatchedManufacturerRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedManufacturerRequest{}
...
type _PatchedManufacturerRequest PatchedManufacturerRequest
...
func NewPatchedManufacturerRequest() *PatchedManufacturerRequest {
	this := PatchedManufacturerRequest{}
	return &this
}
...
func (o PatchedManufacturerRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedManufacturerRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedManufacturerRequest := _PatchedManufacturerRequest{}

	err = json.Unmarshal(data, &varPatchedManufacturerRequest)

	if err != nil {
		return err
	}

	*o = PatchedManufacturerRequest(varPatchedManufacturerRequest)
...
type NullablePatchedManufacturerRequest struct {
	value *PatchedManufacturerRequest
	isSet bool
}

func (v NullablePatchedManufacturerRequest) Get() *PatchedManufacturerRequest {
	return v.value
}

func (v *NullablePatchedManufacturerRequest) Set(val *PatchedManufacturerRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedManufacturerRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedManufacturerRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedManufacturerRequest(val *PatchedManufacturerRequest) *NullablePatchedManufacturerRequest {
	return &NullablePatchedManufacturerRequest{value: val, isSet: true}
}

func (v NullablePatchedManufacturerRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedManufacturerRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
