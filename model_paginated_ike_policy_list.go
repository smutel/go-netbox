...
var _ MappedNullable = &PaginatedIKEPolicyList{}
...
type _PaginatedIKEPolicyList PaginatedIKEPolicyList
...
func (o *PaginatedIKEPolicyList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedIKEPolicyList(varPaginatedIKEPolicyList)
...
type NullablePaginatedIKEPolicyList struct {
	value *PaginatedIKEPolicyList
	isSet bool
}

func (v NullablePaginatedIKEPolicyList) Get() *PaginatedIKEPolicyList {
	return v.value
}

func (v *NullablePaginatedIKEPolicyList) Set(val *PaginatedIKEPolicyList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedIKEPolicyList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedIKEPolicyList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedIKEPolicyList(val *PaginatedIKEPolicyList) *NullablePaginatedIKEPolicyList {
	return &NullablePaginatedIKEPolicyList{value: val, isSet: true}
}

func (v NullablePaginatedIKEPolicyList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedIKEPolicyList) UnmarshalJSON(src []byte) error {
	v.isSet = true
