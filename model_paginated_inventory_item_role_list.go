...
var _ MappedNullable = &PaginatedInventoryItemRoleList{}
...
type _PaginatedInventoryItemRoleList PaginatedInventoryItemRoleList
...
func (o *PaginatedInventoryItemRoleList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedInventoryItemRoleList(varPaginatedInventoryItemRoleList)
...
type NullablePaginatedInventoryItemRoleList struct {
	value *PaginatedInventoryItemRoleList
	isSet bool
}

func (v NullablePaginatedInventoryItemRoleList) Get() *PaginatedInventoryItemRoleList {
	return v.value
}

func (v *NullablePaginatedInventoryItemRoleList) Set(val *PaginatedInventoryItemRoleList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedInventoryItemRoleList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedInventoryItemRoleList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedInventoryItemRoleList(val *PaginatedInventoryItemRoleList) *NullablePaginatedInventoryItemRoleList {
	return &NullablePaginatedInventoryItemRoleList{value: val, isSet: true}
}

func (v NullablePaginatedInventoryItemRoleList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedInventoryItemRoleList) UnmarshalJSON(src []byte) error {
	v.isSet = true
