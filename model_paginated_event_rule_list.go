...
var _ MappedNullable = &PaginatedEventRuleList{}
...
type _PaginatedEventRuleList PaginatedEventRuleList
...
func (o *PaginatedEventRuleList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedEventRuleList(varPaginatedEventRuleList)
...
type NullablePaginatedEventRuleList struct {
	value *PaginatedEventRuleList
	isSet bool
}

func (v NullablePaginatedEventRuleList) Get() *PaginatedEventRuleList {
	return v.value
}

func (v *NullablePaginatedEventRuleList) Set(val *PaginatedEventRuleList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedEventRuleList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedEventRuleList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedEventRuleList(val *PaginatedEventRuleList) *NullablePaginatedEventRuleList {
	return &NullablePaginatedEventRuleList{value: val, isSet: true}
}

func (v NullablePaginatedEventRuleList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedEventRuleList) UnmarshalJSON(src []byte) error {
	v.isSet = true
