...
var _ MappedNullable = &PaginatedRegionList{}
...
type NullablePaginatedRegionList struct {
	value *PaginatedRegionList
	isSet bool
}

func (v NullablePaginatedRegionList) Get() *PaginatedRegionList {
	return v.value
}

func (v *NullablePaginatedRegionList) Set(val *PaginatedRegionList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedRegionList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedRegionList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedRegionList(val *PaginatedRegionList) *NullablePaginatedRegionList {
	return &NullablePaginatedRegionList{value: val, isSet: true}
}

func (v NullablePaginatedRegionList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedRegionList) UnmarshalJSON(src []byte) error {
	v.isSet = true
