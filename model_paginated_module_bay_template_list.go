...
var _ MappedNullable = &PaginatedModuleBayTemplateList{}
...
type NullablePaginatedModuleBayTemplateList struct {
	value *PaginatedModuleBayTemplateList
	isSet bool
}

func (v NullablePaginatedModuleBayTemplateList) Get() *PaginatedModuleBayTemplateList {
	return v.value
}

func (v *NullablePaginatedModuleBayTemplateList) Set(val *PaginatedModuleBayTemplateList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedModuleBayTemplateList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedModuleBayTemplateList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedModuleBayTemplateList(val *PaginatedModuleBayTemplateList) *NullablePaginatedModuleBayTemplateList {
	return &NullablePaginatedModuleBayTemplateList{value: val, isSet: true}
}

func (v NullablePaginatedModuleBayTemplateList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedModuleBayTemplateList) UnmarshalJSON(src []byte) error {
	v.isSet = true
