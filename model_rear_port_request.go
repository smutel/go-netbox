...
type _RearPortRequest RearPortRequest
...
func (o *RearPortRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varRearPortRequest := _RearPortRequest{}

	err = json.Unmarshal(data, &varRearPortRequest)

	if err != nil {
		return err
	}

	*o = RearPortRequest(varRearPortRequest)
