...
var _ MappedNullable = &PaginatedRIRList{}
...
type _PaginatedRIRList PaginatedRIRList
...
func (o *PaginatedRIRList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedRIRList(varPaginatedRIRList)
...
type NullablePaginatedRIRList struct {
	value *PaginatedRIRList
	isSet bool
}

func (v NullablePaginatedRIRList) Get() *PaginatedRIRList {
	return v.value
}

func (v *NullablePaginatedRIRList) Set(val *PaginatedRIRList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedRIRList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedRIRList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedRIRList(val *PaginatedRIRList) *NullablePaginatedRIRList {
	return &NullablePaginatedRIRList{value: val, isSet: true}
}

func (v NullablePaginatedRIRList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedRIRList) UnmarshalJSON(src []byte) error {
	v.isSet = true
