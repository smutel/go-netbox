...
var _ MappedNullable = &PaginatedPowerPanelList{}
...
type _PaginatedPowerPanelList PaginatedPowerPanelList
...
func (o *PaginatedPowerPanelList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedPowerPanelList(varPaginatedPowerPanelList)
...
type NullablePaginatedPowerPanelList struct {
	value *PaginatedPowerPanelList
	isSet bool
}

func (v NullablePaginatedPowerPanelList) Get() *PaginatedPowerPanelList {
	return v.value
}

func (v *NullablePaginatedPowerPanelList) Set(val *PaginatedPowerPanelList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedPowerPanelList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedPowerPanelList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedPowerPanelList(val *PaginatedPowerPanelList) *NullablePaginatedPowerPanelList {
	return &NullablePaginatedPowerPanelList{value: val, isSet: true}
}

func (v NullablePaginatedPowerPanelList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedPowerPanelList) UnmarshalJSON(src []byte) error {
	v.isSet = true
