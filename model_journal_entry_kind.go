...
// checks if the JournalEntryKind type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JournalEntryKind{}
...
// SetValue gets a reference to the given JournalEntryKindValue and assigns it to the Value field.
...
// SetLabel gets a reference to the given JournalEntryKindLabel and assigns it to the Label field.
...
func (o JournalEntryKind) ToMap() (map[string]interface{}, error) {
...
func (o *JournalEntryKind) UnmarshalJSON(data []byte) (err error) {
	varJournalEntryKind := _JournalEntryKind{}

	err = json.Unmarshal(data, &varJournalEntryKind)
...
func (v NullableJournalEntryKind) Get() *JournalEntryKind {
	return v.value
}

func (v *NullableJournalEntryKind) Set(val *JournalEntryKind) {
	v.value = val
	v.isSet = true
}

func (v NullableJournalEntryKind) IsSet() bool {
	return v.isSet
}

func (v *NullableJournalEntryKind) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJournalEntryKind(val *JournalEntryKind) *NullableJournalEntryKind {
	return &NullableJournalEntryKind{value: val, isSet: true}
}

func (v NullableJournalEntryKind) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJournalEntryKind) UnmarshalJSON(src []byte) error {
	v.isSet = true
