...
var _ MappedNullable = &PaginatedDataFileList{}
...
type _PaginatedDataFileList PaginatedDataFileList
...
func (o *PaginatedDataFileList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedDataFileList(varPaginatedDataFileList)
...
type NullablePaginatedDataFileList struct {
	value *PaginatedDataFileList
	isSet bool
}

func (v NullablePaginatedDataFileList) Get() *PaginatedDataFileList {
	return v.value
}

func (v *NullablePaginatedDataFileList) Set(val *PaginatedDataFileList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedDataFileList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedDataFileList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedDataFileList(val *PaginatedDataFileList) *NullablePaginatedDataFileList {
	return &NullablePaginatedDataFileList{value: val, isSet: true}
}

func (v NullablePaginatedDataFileList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedDataFileList) UnmarshalJSON(src []byte) error {
	v.isSet = true
