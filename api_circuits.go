...
func (a *CircuitsAPIService) CircuitsCircuitTerminationsListExecute(r ApiCircuitsCircuitTerminationsListRequest) (*PaginatedCircuitTerminationList, *http.Response, error) {
	...
	if r.cableEndN != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "cable_end__n", r.cableEndN, "form", "")
	}
	if r.cableId != nil {
		t := *r.cableId
	...
	if r.termSideN != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "term_side__n", r.termSideN, "form", "")
	}
