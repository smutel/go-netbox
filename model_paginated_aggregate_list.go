...
var _ MappedNullable = &PaginatedAggregateList{}
...
type NullablePaginatedAggregateList struct {
	value *PaginatedAggregateList
	isSet bool
}

func (v NullablePaginatedAggregateList) Get() *PaginatedAggregateList {
	return v.value
}

func (v *NullablePaginatedAggregateList) Set(val *PaginatedAggregateList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedAggregateList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedAggregateList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedAggregateList(val *PaginatedAggregateList) *NullablePaginatedAggregateList {
	return &NullablePaginatedAggregateList{value: val, isSet: true}
}

func (v NullablePaginatedAggregateList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedAggregateList) UnmarshalJSON(src []byte) error {
	v.isSet = true
