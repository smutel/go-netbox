...
var _ MappedNullable = &PaginatedInventoryItemTemplateList{}
...
type _PaginatedInventoryItemTemplateList PaginatedInventoryItemTemplateList
...
func (o *PaginatedInventoryItemTemplateList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedInventoryItemTemplateList(varPaginatedInventoryItemTemplateList)
...
type NullablePaginatedInventoryItemTemplateList struct {
	value *PaginatedInventoryItemTemplateList
	isSet bool
}

func (v NullablePaginatedInventoryItemTemplateList) Get() *PaginatedInventoryItemTemplateList {
	return v.value
}

func (v *NullablePaginatedInventoryItemTemplateList) Set(val *PaginatedInventoryItemTemplateList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedInventoryItemTemplateList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedInventoryItemTemplateList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedInventoryItemTemplateList(val *PaginatedInventoryItemTemplateList) *NullablePaginatedInventoryItemTemplateList {
	return &NullablePaginatedInventoryItemTemplateList{value: val, isSet: true}
}

func (v NullablePaginatedInventoryItemTemplateList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedInventoryItemTemplateList) UnmarshalJSON(src []byte) error {
	v.isSet = true
