...
var _ MappedNullable = &PaginatedPowerFeedList{}
...
type _PaginatedPowerFeedList PaginatedPowerFeedList
...
func (o *PaginatedPowerFeedList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedPowerFeedList(varPaginatedPowerFeedList)
...
type NullablePaginatedPowerFeedList struct {
	value *PaginatedPowerFeedList
	isSet bool
}

func (v NullablePaginatedPowerFeedList) Get() *PaginatedPowerFeedList {
	return v.value
}

func (v *NullablePaginatedPowerFeedList) Set(val *PaginatedPowerFeedList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedPowerFeedList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedPowerFeedList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedPowerFeedList(val *PaginatedPowerFeedList) *NullablePaginatedPowerFeedList {
	return &NullablePaginatedPowerFeedList{value: val, isSet: true}
}

func (v NullablePaginatedPowerFeedList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedPowerFeedList) UnmarshalJSON(src []byte) error {
	v.isSet = true
