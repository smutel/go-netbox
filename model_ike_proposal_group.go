...
type _IKEProposalGroup IKEProposalGroup
...
func (o *IKEProposalGroup) UnmarshalJSON(data []byte) (err error) {
	varIKEProposalGroup := _IKEProposalGroup{}

	err = json.Unmarshal(data, &varIKEProposalGroup)

	if err != nil {
		return err
	}

	*o = IKEProposalGroup(varIKEProposalGroup)
