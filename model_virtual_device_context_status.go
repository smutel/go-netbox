...
// checks if the VirtualDeviceContextStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualDeviceContextStatus{}
...
type _VirtualDeviceContextStatus VirtualDeviceContextStatus
...
func NewVirtualDeviceContextStatus() *VirtualDeviceContextStatus {
	this := VirtualDeviceContextStatus{}
	return &this
}
...
func (o VirtualDeviceContextStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualDeviceContextStatus) UnmarshalJSON(data []byte) (err error) {
	varVirtualDeviceContextStatus := _VirtualDeviceContextStatus{}

	err = json.Unmarshal(data, &varVirtualDeviceContextStatus)

	if err != nil {
		return err
	}

	*o = VirtualDeviceContextStatus(varVirtualDeviceContextStatus)
...
type NullableVirtualDeviceContextStatus struct {
	value *VirtualDeviceContextStatus
	isSet bool
}

func (v NullableVirtualDeviceContextStatus) Get() *VirtualDeviceContextStatus {
	return v.value
}

func (v *NullableVirtualDeviceContextStatus) Set(val *VirtualDeviceContextStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualDeviceContextStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualDeviceContextStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualDeviceContextStatus(val *VirtualDeviceContextStatus) *NullableVirtualDeviceContextStatus {
	return &NullableVirtualDeviceContextStatus{value: val, isSet: true}
}

func (v NullableVirtualDeviceContextStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualDeviceContextStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
