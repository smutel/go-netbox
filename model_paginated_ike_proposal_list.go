...
var _ MappedNullable = &PaginatedIKEProposalList{}
...
type _PaginatedIKEProposalList PaginatedIKEProposalList
...
func (o *PaginatedIKEProposalList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedIKEProposalList(varPaginatedIKEProposalList)
...
type NullablePaginatedIKEProposalList struct {
	value *PaginatedIKEProposalList
	isSet bool
}

func (v NullablePaginatedIKEProposalList) Get() *PaginatedIKEProposalList {
	return v.value
}

func (v *NullablePaginatedIKEProposalList) Set(val *PaginatedIKEProposalList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedIKEProposalList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedIKEProposalList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedIKEProposalList(val *PaginatedIKEProposalList) *NullablePaginatedIKEProposalList {
	return &NullablePaginatedIKEProposalList{value: val, isSet: true}
}

func (v NullablePaginatedIKEProposalList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedIKEProposalList) UnmarshalJSON(src []byte) error {
	v.isSet = true
