...
var _ MappedNullable = &PaginatedFrontPortList{}
...
type _PaginatedFrontPortList PaginatedFrontPortList
...
func (o *PaginatedFrontPortList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedFrontPortList(varPaginatedFrontPortList)
...
type NullablePaginatedFrontPortList struct {
	value *PaginatedFrontPortList
	isSet bool
}

func (v NullablePaginatedFrontPortList) Get() *PaginatedFrontPortList {
	return v.value
}

func (v *NullablePaginatedFrontPortList) Set(val *PaginatedFrontPortList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedFrontPortList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedFrontPortList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedFrontPortList(val *PaginatedFrontPortList) *NullablePaginatedFrontPortList {
	return &NullablePaginatedFrontPortList{value: val, isSet: true}
}

func (v NullablePaginatedFrontPortList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedFrontPortList) UnmarshalJSON(src []byte) error {
	v.isSet = true
