...
var _ MappedNullable = &PaginatedFrontPortTemplateList{}
...
type _PaginatedFrontPortTemplateList PaginatedFrontPortTemplateList
...
func (o *PaginatedFrontPortTemplateList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedFrontPortTemplateList(varPaginatedFrontPortTemplateList)
...
type NullablePaginatedFrontPortTemplateList struct {
	value *PaginatedFrontPortTemplateList
	isSet bool
}

func (v NullablePaginatedFrontPortTemplateList) Get() *PaginatedFrontPortTemplateList {
	return v.value
}

func (v *NullablePaginatedFrontPortTemplateList) Set(val *PaginatedFrontPortTemplateList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedFrontPortTemplateList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedFrontPortTemplateList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedFrontPortTemplateList(val *PaginatedFrontPortTemplateList) *NullablePaginatedFrontPortTemplateList {
	return &NullablePaginatedFrontPortTemplateList{value: val, isSet: true}
}

func (v NullablePaginatedFrontPortTemplateList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedFrontPortTemplateList) UnmarshalJSON(src []byte) error {
	v.isSet = true
