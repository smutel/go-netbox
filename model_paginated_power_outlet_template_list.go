...
var _ MappedNullable = &PaginatedPowerOutletTemplateList{}
...
type NullablePaginatedPowerOutletTemplateList struct {
	value *PaginatedPowerOutletTemplateList
	isSet bool
}

func (v NullablePaginatedPowerOutletTemplateList) Get() *PaginatedPowerOutletTemplateList {
	return v.value
}

func (v *NullablePaginatedPowerOutletTemplateList) Set(val *PaginatedPowerOutletTemplateList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedPowerOutletTemplateList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedPowerOutletTemplateList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedPowerOutletTemplateList(val *PaginatedPowerOutletTemplateList) *NullablePaginatedPowerOutletTemplateList {
	return &NullablePaginatedPowerOutletTemplateList{value: val, isSet: true}
}

func (v NullablePaginatedPowerOutletTemplateList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedPowerOutletTemplateList) UnmarshalJSON(src []byte) error {
	v.isSet = true
