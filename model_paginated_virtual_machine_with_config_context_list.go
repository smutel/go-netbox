...
var _ MappedNullable = &PaginatedVirtualMachineWithConfigContextList{}
...
type NullablePaginatedVirtualMachineWithConfigContextList struct {
	value *PaginatedVirtualMachineWithConfigContextList
	isSet bool
}

func (v NullablePaginatedVirtualMachineWithConfigContextList) Get() *PaginatedVirtualMachineWithConfigContextList {
	return v.value
}

func (v *NullablePaginatedVirtualMachineWithConfigContextList) Set(val *PaginatedVirtualMachineWithConfigContextList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedVirtualMachineWithConfigContextList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedVirtualMachineWithConfigContextList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedVirtualMachineWithConfigContextList(val *PaginatedVirtualMachineWithConfigContextList) *NullablePaginatedVirtualMachineWithConfigContextList {
	return &NullablePaginatedVirtualMachineWithConfigContextList{value: val, isSet: true}
}

func (v NullablePaginatedVirtualMachineWithConfigContextList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedVirtualMachineWithConfigContextList) UnmarshalJSON(src []byte) error {
	v.isSet = true
