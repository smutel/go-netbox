...
var _ MappedNullable = &PaginatedContactRoleList{}
...
type _PaginatedContactRoleList PaginatedContactRoleList
...
func (o *PaginatedContactRoleList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedContactRoleList(varPaginatedContactRoleList)
...
type NullablePaginatedContactRoleList struct {
	value *PaginatedContactRoleList
	isSet bool
}

func (v NullablePaginatedContactRoleList) Get() *PaginatedContactRoleList {
	return v.value
}

func (v *NullablePaginatedContactRoleList) Set(val *PaginatedContactRoleList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedContactRoleList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedContactRoleList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedContactRoleList(val *PaginatedContactRoleList) *NullablePaginatedContactRoleList {
	return &NullablePaginatedContactRoleList{value: val, isSet: true}
}

func (v NullablePaginatedContactRoleList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedContactRoleList) UnmarshalJSON(src []byte) error {
	v.isSet = true
