...
var _ MappedNullable = &PaginatedCustomLinkList{}
...
type _PaginatedCustomLinkList PaginatedCustomLinkList
...
func (o *PaginatedCustomLinkList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedCustomLinkList(varPaginatedCustomLinkList)
...
type NullablePaginatedCustomLinkList struct {
	value *PaginatedCustomLinkList
	isSet bool
}

func (v NullablePaginatedCustomLinkList) Get() *PaginatedCustomLinkList {
	return v.value
}

func (v *NullablePaginatedCustomLinkList) Set(val *PaginatedCustomLinkList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedCustomLinkList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedCustomLinkList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedCustomLinkList(val *PaginatedCustomLinkList) *NullablePaginatedCustomLinkList {
	return &NullablePaginatedCustomLinkList{value: val, isSet: true}
}

func (v NullablePaginatedCustomLinkList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedCustomLinkList) UnmarshalJSON(src []byte) error {
	v.isSet = true
