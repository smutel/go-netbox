...
const (
	...
	WIRELESSCHANNEL__60G_13_68040_4320 WirelessChannel = "60g-13-68040-4320"
	WIRELESSCHANNEL__60G_17_60480_6480 WirelessChannel = "60g-17-60480-6480"
	WIRELESSCHANNEL__60G_18_62640_6480 WirelessChannel = "60g-18-62640-6480"
	WIRELESSCHANNEL__60G_19_64800_6480 WirelessChannel = "60g-19-64800-6480"
	WIRELESSCHANNEL__60G_20_66960_6480 WirelessChannel = "60g-20-66960-6480"
...
var AllowedWirelessChannelEnumValues = []WirelessChannel{
	"2.4g-1-2412-22",
	"2.4g-2-2417-22",
	"2.4g-3-2422-22",
	"2.4g-4-2427-22",
...
func (v *WirelessChannel) UnmarshalJSON(src []byte) error {
	var value string
...
func NewWirelessChannelFromValue(v string) (*WirelessChannel, error) {
	ev := WirelessChannel(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for WirelessChannel: valid values are %v", v, AllowedWirelessChannelEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v WirelessChannel) IsValid() bool {
	for _, existing := range AllowedWirelessChannelEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to Wireless_channel value
func (v WirelessChannel) Ptr() *WirelessChannel {
	return &v
}

type NullableWirelessChannel struct {
	value *WirelessChannel
	isSet bool
}

func (v NullableWirelessChannel) Get() *WirelessChannel {
	return v.value
}

func (v *NullableWirelessChannel) Set(val *WirelessChannel) {
	v.value = val
	v.isSet = true
}

func (v NullableWirelessChannel) IsSet() bool {
	return v.isSet
}

func (v *NullableWirelessChannel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWirelessChannel(val *WirelessChannel) *NullableWirelessChannel {
	return &NullableWirelessChannel{value: val, isSet: true}
}

func (v NullableWirelessChannel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWirelessChannel) UnmarshalJSON(src []byte) error {
	v.isSet = true
