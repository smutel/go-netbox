...
// checks if the InterfaceRfRole type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InterfaceRfRole{}
...
type _InterfaceRfRole InterfaceRfRole
...
func (o InterfaceRfRole) ToMap() (map[string]interface{}, error) {
...
func (o *InterfaceRfRole) UnmarshalJSON(data []byte) (err error) {
	varInterfaceRfRole := _InterfaceRfRole{}

	err = json.Unmarshal(data, &varInterfaceRfRole)

	if err != nil {
		return err
	}

	*o = InterfaceRfRole(varInterfaceRfRole)
...
type NullableInterfaceRfRole struct {
	value *InterfaceRfRole
	isSet bool
}

func (v NullableInterfaceRfRole) Get() *InterfaceRfRole {
	return v.value
}

func (v *NullableInterfaceRfRole) Set(val *InterfaceRfRole) {
	v.value = val
	v.isSet = true
}

func (v NullableInterfaceRfRole) IsSet() bool {
	return v.isSet
}

func (v *NullableInterfaceRfRole) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInterfaceRfRole(val *InterfaceRfRole) *NullableInterfaceRfRole {
	return &NullableInterfaceRfRole{value: val, isSet: true}
}

func (v NullableInterfaceRfRole) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInterfaceRfRole) UnmarshalJSON(src []byte) error {
	v.isSet = true
