...
var _ MappedNullable = &PaginatedInventoryItemList{}
...
type NullablePaginatedInventoryItemList struct {
	value *PaginatedInventoryItemList
	isSet bool
}

func (v NullablePaginatedInventoryItemList) Get() *PaginatedInventoryItemList {
	return v.value
}

func (v *NullablePaginatedInventoryItemList) Set(val *PaginatedInventoryItemList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedInventoryItemList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedInventoryItemList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedInventoryItemList(val *PaginatedInventoryItemList) *NullablePaginatedInventoryItemList {
	return &NullablePaginatedInventoryItemList{value: val, isSet: true}
}

func (v NullablePaginatedInventoryItemList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedInventoryItemList) UnmarshalJSON(src []byte) error {
	v.isSet = true
