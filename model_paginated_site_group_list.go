...
var _ MappedNullable = &PaginatedSiteGroupList{}
...
type _PaginatedSiteGroupList PaginatedSiteGroupList
...
func (o *PaginatedSiteGroupList) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaginatedSiteGroupList(varPaginatedSiteGroupList)
...
type NullablePaginatedSiteGroupList struct {
	value *PaginatedSiteGroupList
	isSet bool
}

func (v NullablePaginatedSiteGroupList) Get() *PaginatedSiteGroupList {
	return v.value
}

func (v *NullablePaginatedSiteGroupList) Set(val *PaginatedSiteGroupList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedSiteGroupList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedSiteGroupList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedSiteGroupList(val *PaginatedSiteGroupList) *NullablePaginatedSiteGroupList {
	return &NullablePaginatedSiteGroupList{value: val, isSet: true}
}

func (v NullablePaginatedSiteGroupList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedSiteGroupList) UnmarshalJSON(src []byte) error {
	v.isSet = true
